  ...
  return (
    <div className="bg-background">
      <section className="pt-12 pb-12 md:pt-20 md:pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-heading font-extrabold mb-4">
            Kunjungi Klinik Kami di <span className="text-primary">Jakarta Timur</span>
          </h1>
        ...
        >
          {CARDS.map((c) => (
            <motion.article
              key={c.id}
              variants={fadeUp}
              className="bg-white rounded-3xl p-6 md:p-8 border border-primary/10 shadow-sm flex flex-col"
            >
              ...
              {c.variant === "onsite" ? (
                ...
                <div className="mt-auto">
                  {online ? (
                    ...
                    <div className="text-sm text-text-secondary bg-background border border-primary/10 rounded-xl p-4">
                      Layanan booking online sedang kami persiapkan. Anda akan dapat memesan sesi konsultasi psikolog online melalui <span className="font-mono text-primary">{new URL(BOOKING_ONLINE_URL).host}</span> dalam waktu dekat.
                    </div>
                  )}
                </div>
              )}
      ...
      <section className="pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 border border-primary/10 shadow-sm">
          ...
          <div className="aspect-video rounded-2xl overflow-hidden bg-primary/5">
            <iframe
